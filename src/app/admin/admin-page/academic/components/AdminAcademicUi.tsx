...
export function AcademicModal({
  ...
  return (
    <div
      ...
      role="dialog"
    >
      <div className={`max-h-[92vh] w-full ${widthClass} overflow-y-auto rounded-[30px] border border-black/5 bg-white shadow-2xl`}>
        <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-black/5 bg-white p-5 sm:p-6">
          <div>
            ...
            <h3 className="mt-2 text-2xl font-extrabold text-[#1b1c19] sm:text-3xl">
              {title}
            </h3>
            {description ? (
